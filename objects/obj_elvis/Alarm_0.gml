...

{
	if !elvis_is_speaking() && !instance_exists(obj_fade_to) && irandom(2) != 0 {
		...
		if !irandom(50) _snd = choose(vo_chatter_rare01, vo_chatter_rare02, vo_chatter_rare03, vo_chatter_rare04, vo_chatter_rare05, vo_chatter_rare06, vo_chatter_rare07, vo_chatter_rare08);
